...
You can check the contract's abi by using 'cleon get code' command.)=====";
...
If you are currently using 'cleon push action' command, try to add the relevant authority using -p option.)=====";
