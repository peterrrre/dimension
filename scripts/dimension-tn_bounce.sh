#!/bin/bash
#
# dimension-tn_bounce is used to restart a node that is acting badly or is down.
# usage: dimension-tn_bounce.sh [arglist]
...
# the command line.
#
# in most cases, simply running ./dimension-tn_bounce.sh is sufficient.
#
