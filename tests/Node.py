...
class Node(object):
    ...
    def getAccountEosBalanceStr(self, scope):
        """Returns SYS currency0000 account balance from cleon get table command. Returned balance is string following syntax "98.0311 SYS". """
        assert isinstance(scope, str)
    ...
    def getAccountEosBalance(self, scope):
        """Returns SYS currency0000 account balance from cleon get table command. Returned balance is an integer e.g. 980311. """
