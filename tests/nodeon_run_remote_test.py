...
pnodes=1
total_nodes=pnodes
actualTest="tests/nodeon_run_test.py"
...
try:
    ...
    Print("Starting up %s test: %s" % ("nodeon", actualTest))
    Print("cmd: %s\n" % (cmd))
